...
@Component({
  ...
  providers: [ChangePasswordService, ToasterService, StorageService]
})
export class ChangePasswordComponent implements OnInit {
  ...
  changePassword() {
    ...
    try {
      ...
      const parentID = loggedInUserData.parentId;
      const userType = loggedInUserData.userType;
      const data = {};
      ...
      this.changePasswordService.changePassword(data, userName, userType, parentID) // userType, parentID
        .subscribe(
          a => {
